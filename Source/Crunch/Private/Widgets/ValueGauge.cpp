...
void UValueGauge::SetAndBoundToGameplayAttributes(class UAbilitySystemComponent* AbilitySystemComponent, const FGameplayAttribute& Attribute, const FGameplayAttribute& MaxAttribute)
{
